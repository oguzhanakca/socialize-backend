...
class ProfileList(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        return Profile.objects.annotate(
            ...
            ).filter(models.Q(is_private=False) | models.Q(owner__following__followed=user) | models.Q(owner=user) | models.Q(owner__followed__owner=user)).order_by('-created_at')
